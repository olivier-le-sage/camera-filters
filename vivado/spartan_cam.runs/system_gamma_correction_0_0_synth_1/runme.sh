...
HD_PWD='C:/Users/lesag/Documents/University/Personal_Projects/SEA_demo_projects/MIPI-In-HDMI-Out/spartan_cam/spartan_cam.runs/system_gamma_correction_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_gamma_correction_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_gamma_correction_0_0.tcl
