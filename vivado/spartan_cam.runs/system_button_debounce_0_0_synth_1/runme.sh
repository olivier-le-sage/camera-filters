...
HD_PWD='C:/Users/lesag/Documents/University/Personal_Projects/camera-filters/vivado/spartan_cam.runs/system_button_debounce_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_button_debounce_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_button_debounce_0_0.tcl
